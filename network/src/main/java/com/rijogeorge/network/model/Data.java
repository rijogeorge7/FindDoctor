...
public class Data {
    ...
    {
        return "ClassPojo [uid = "+uid+", practices = "+practices+", claims = "+claims+", insurances = "+insurances+", specialties = "+specialties+", npi = "+npi+", licenses = "+licenses+", group_affiliations = "+group_affiliations+", educations = "+educations+", hospital_affiliations = "+hospital_affiliations+", ratings = "+ratings+", profile = "+profile+"]";
    }
}
